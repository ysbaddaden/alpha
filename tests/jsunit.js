...
{
//  document.write(jsUnit.runningTest + ' <strong>' + (result ? 'yes' : 'no') + '</strong><br>');
  ...
  if (!jsUnit.results)
  {
    ...
    // TBODY
    jsUnit.results = document.createElement('tbody');
    table.appendChild(jsUnit.results);
