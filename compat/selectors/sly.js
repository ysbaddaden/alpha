 ...
 * 
 * This is a fork of Sly v1.0rc1 <http://sly.digitarald.com>
 ...
 *  - querySelectorAll has been deactivated (no use, we replace it when missing or obviously limited).
 *  - non standard selectors have been removed (:contains, !=).
 *  - CSS3 pseudo selectors have been added (:root, :target, :only-child)
 * 
 * Lacks:
 * 
 *  - support for :*-of-type CSS3 selectors.
