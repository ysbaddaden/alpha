...
JS-compat::Compat is an obstrusive javascript library that
...
Event, before IE8. JS-compat::Compat thus emulates Element and
...
don't want to have to think about that, so JS-compat::Compat
...
still relies on attachEvent, detachEvent, etc. JS-compat::Compat
...
JS-compat::Compat also fixes the Event object passed to the callback
...
goal of JS-compat::Compat is to implement (or emulate) these
