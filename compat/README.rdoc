...
thus implements them. Support is limited to the bubbling mode only.
...
If excanvas.js is loaded, created elements will be automatically extended
(thanks to Kokone::Compat).
