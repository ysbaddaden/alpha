...
// 
// FIXME: When the options do change you can't select any option anymore (except for the first one by hitting ENTER) [fixed?]
// FIXME: When the options get empty the chooser disapears, and never gets back, even though there are options (unless you click the input).
