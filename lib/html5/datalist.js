...
// 
// FIXME: Internet Explorer & Safari bug: when the options do change you can't select any option anymore (except for the first one by hitting ENTER).
// FIXME: Safari doesn't look like to fire the DOMSubtreeModified event with InnerHTML or appendChild(documentFragment)?
...
//{
  ...
  HTML5.Datalist.prototype.startOptionsTracking = function()
  {
//    if (HTML5.supportsDOMSubtreeModifiedEvent())
//    {
//      this.bound_updater = this.updateChooserProposals.bind(this)
//      this.datalist.addEventListener('DOMSubtreeModified', this.bound_updater, false);
//    }
//    else
//    {
//      console.log('Poll at regular intervals for changes...');
      this.previousOptionsHTML = this.datalist.innerHTML;
      this.optionsSubtreeTracker = setInterval(this.checkOptionsSubtreeForModifications.bind(this), 100);
//    }
  }
  
  HTML5.Datalist.prototype.stopOptionsTracking = function()
  {
//    if (HTML5.supportsDOMSubtreeModifiedEvent())
//    {
//      this.datalist.removeEventListener('DOMSubtreeModified', this.bound_updater, false);
//      delete this.bound_updater;
//    }
//    else {
      clearInterval(this.optionsSubtreeTracker);
//    }
  }
  
  HTML5.Datalist.prototype.checkOptionsSubtreeForModifications = function(evt)
  {
    if (this.previousOptionsHTML != this.datalist.innerHTML) {
  ...
  // TODO: updateChooserProposals() should recreate the whole chooser (that should fix IE & Safari).
