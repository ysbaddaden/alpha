...
// TODO: Track changes of datalist.options and update displayed options.
...
//{
  ...
  {
    this.bound_ondomsubtreemodified = this.ondomsubtreemodified.bind(this)
    this.datalist.addEventListener('DOMSubtreeModified', this.bound_ondomsubtreemodified, false);
  }
  
  HTML5.Datalist.prototype.stopOptionsTracking = function()
  {
    this.datalist.removeEventListener('DOMSubtreeModified', this.bound_ondomsubtreemodified, false);
    delete this.bound_ondomsubtreemodified;
  }
  
  HTML5.Datalist.prototype.ondomsubtreemodified = function(evt) {
