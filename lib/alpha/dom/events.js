 ...
 * 
 * FIXME: keyboard events do not set keyCode, which nor charCode?
 */
  ...
  Element.prototype.addEventListener = function(type, listener, useCapture)
  {
    ...
    if (!this._Alpha_events[type])
    {
      ...
      this._Alpha_events[type] = {
        ...
        {
          // the event object
          self['_Alpha_event_' + type + '_event'] = Alpha.event(self);
          ...
          // copies properties for preventDefault() and stopPropagation() do have any effect
          window.event.returnValue  = self['_Alpha_event_' + type + '_event'].returnValue;
          window.event.cancelBubble = self['_Alpha_event_' + type + '_event'].cancelBubble;
        },
