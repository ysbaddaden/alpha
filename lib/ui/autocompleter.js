// TODO: Extract Alpha.UI.RemoteAutocompleter from Alpha.UI.Autocompleter & Alpha.UI.RemoteDatalistAutocompleter.

Alpha.UI.Autocompleter = function(input, options)
{
...
Alpha.UI.Autocompleter.prototype = {
...
/*
Alpha.UI.Autocompleter: function(input, url, options) {
  this.initialize(input, url, options);
}

Alpha.UI.Autocompleter.prototype.initialize: function(input, url, options)
{
  if (typeof input == 'undefined') {
    throw new Error("Alpha.UI.Autocompleter: missing parameter 'input'.");
  }
  if (typeof url == 'undefined') {
    throw new Error("Alpha.UI.Autocompleter: missing parameter 'url'.");
  }
...
Alpha.UI.Autocompleter.prototype.setUrl: function(url) {
  this.ajax.options.url = url;
}

Alpha.UI.Autocompleter.prototype.getToken: function()
{
  var token;
...
Alpha.UI.Autocompleter.prototype.setToken: function(token)
{
	if (this.options.multipleTokens &&
	  this.input.value.indexOf(this.options.tokenSeparator) > -1)
	{
...
Alpha.UI.Autocompleter.prototype.onInput: function(evt)
{
  switch(evt.keyCode)
  {
...
Alpha.UI.Autocompleter.prototype.request: function()
{
  this.ajax.abort();
...
Alpha.UI.Autocompleter.prototype.updateList: function(html)
{
...
Alpha.UI.Autocompleter.prototype.onChoice: function(evt)
{
...
Alpha.UI.Autocompleter.prototype.markSelection: function(selection)
{
  if (this.selection) {
...
Alpha.UI.Autocompleter.prototype.hoverSelection: function(evt)
{
  if (evt.target.tagName.toUpperCase() == 'LI') {
...
Alpha.UI.Autocompleter.prototype.moveSelectionUp: function()
{
  if (this.selection)
  {
...
Alpha.UI.Autocompleter.prototype.moveSelectionDown: function()
{
  if (this.selection)
  {
...
Alpha.UI.Autocompleter.prototype.selectSelection: function()
{
  if (this.selection)
  {
...
Alpha.UI.Autocompleter.prototype.cancel: function()
{
  this.picker.hide();
  this.list.innerHTML = '';
  this.selection = null;
