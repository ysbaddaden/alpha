...
// Updates a datalist options through remote HTTP calls like:
// 
...
// 
Alpha.UI.RemoteAutocompleter = function(input, options)
{
...
Alpha.UI.RemoteAutocompleter.prototype.onType = function(event)
{
...
Alpha.UI.RemoteAutocompleter.prototype.callback = function(html)
{
...
Alpha.UI.RemoteAutocompleter.prototype.setDatalistOptions = function(html) {
  (this.select || this.datalist).innerHTML = html;
}

Alpha.UI.RemoteAutocompleter.prototype.resetDatalistOptions = function() {
