...
Alpha.UI.ListPicker.prototype = {
  ...
  // +list+ must be an Array or an HTMLCollection of LI elements.
  ...
  onselect: function(item) {
    throw new Error("Error: you must overwrite the onselect(item) method.");
  },
  ...
  {
    this.input.addEventListener('focus',    this.active.bind(this),     false);
    this.input.addEventListener('click',    this.active.bind(this),     false);
    this.input.addEventListener('blur',     this.deactive.bind(this),   false);
